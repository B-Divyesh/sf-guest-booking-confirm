const CACHE = 'gbc-shell-v4';
const SHELL = ['/', '/assets/favicon.svg', '/assets/confirmation-console-fallback.svg', '/assets/editorial-calendar-texture.webp', '/assets/editorial-paper-grain.webp'];
